  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "4vjm9qB3-yIM",
        "outputId": "89854f86-ea34-4132-e067-6a8a127b5a2d"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "t1vxtHpWLm2h",
        "outputId": "25232df4-cd1e-4699-b6c4-30c1566b8263"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "Requirement already satisfied: imageio in /usr/local/lib/python3.13/dist-packages (2.37.4)\n",
            "Requirement already satisfied: matplotlib in /usr/local/lib/python3.13/dist-packages (3.10.0)\n",
            "Requirement already satisfied: pillow>=8.3.2 in /usr/local/lib/python3.13/dist-packages (from imageio) (11.3.0)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Y91O-kNH_Voh",
        "outputId": "507582f9-5724-4323-fac0-b69d60430032"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "VySbxDdnB6Ng",
        "outputId": "bc3559ae-2040-4753-a4ee-3f9efa73a69e"
      },
      "outputs": [
        {
          "output_type": "stream",
          "name": "stdout",
          "text": [
            "/content/gdrive/My Drive/cs182fa26_public/cs182fa26_public/hw00/code/deeplearning/datasets\n",
            "--2026-08-31 21:40:13--  http://www.cs.toronto.edu/~kriz/cifar-10-python.tar.gz\n",
            "Resolving www.cs.toronto.edu (www.cs.toronto.edu)... 128.100.3.30\n",
            "Connecting to www.cs.toronto.edu (www.cs.toronto.edu)|128.100.3.30|:80... connected.\n",
            "HTTP request sent, awaiting response... 301 Moved Permanently\n",
            "Location: https://cave.cs.toronto.edu/kriz/cifar-10-python.tar.gz [following]\n",
            "--2026-08-31 21:40:13--  https://cave.cs.toronto.edu/kriz/cifar-10-python.tar.gz\n",
            ...
            "\n",
            "cifar-10-python.tar  98%[==================> ] 160.43M  79.1KB/s    eta 23s    "
          ]
        }
      ],
      "source": [
